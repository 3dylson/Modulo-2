package com.example.android.sunshine.data.database.entity;
...
public class Weather {
     ...
     * converts this data to Weather objects using this constructor.
     *
     ...
     */
    @Ignore
    public Weather(int weatherIconId, Date date, double min, double max, double humidity, double pressure, double wind, double degrees) {
    ...
    public Weather(int id, int weatherIconId, Date date, double min, double max, double humidity, double pressure, double wind, double degrees) {
        this.id = id;
        this.weatherIconId = weatherIconId;
        this.date = date;
        this.min = min;
